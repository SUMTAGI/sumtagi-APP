      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            ...
            Text('${_favorites.length}개의 즐겨찾기', style: const TextStyle(fontSize: 14, color: AppColors.gray500)),
          ],
        ),
              ...
              ? const Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text('마음에 드는 섬을 찜해보세요!', style: TextStyle(fontSize: 14, color: AppColors.gray400)),
                    ],
                  ),
                )
              : RefreshIndicator(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(island.description, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 14, color: AppColors.gray500)),
                                      const SizedBox(height: 8),
                                      Row(children: [
                                        const Icon(Icons.directions_boat_rounded, size: 12, color: AppColors.gray400),
                                        const SizedBox(width: 3),
                                        Text(island.ferryTime, style: const TextStyle(fontSize: 14, color: AppColors.gray600)),
                                        const SizedBox(width: 8),
                                        Container(
                                          padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                          decoration: BoxDecoration(color: _congestionBg(island.congestion), borderRadius: BorderRadius.circular(4)),
                                          child: Text(_congestionLabel(island.congestion), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: _congestionText(island.congestion))),
                                        ),
                                      ]),
                                    ],
                                  ),
