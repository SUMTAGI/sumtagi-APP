...
class _SupportScreenState extends State<SupportScreen> {
  ...
  static const _faqs = [
    ...
    {'id': 'f4', 'question': '패키지 여행 예약 방법을 알려주세요', 'answer': '패키지 상품 메뉴에서 원하는 패키지를 선택하고 일정 생성 버튼을 누르시면 됩니다. 이후 예약 관리에서 확인 가능합니다.'},
    {'id': 'f5', 'question': '쿠폰은 어떻게 사용하나요?', 'answer': '쿠폰함에서 원하는 쿠폰을 다운로드한 후 예약 시 쿠폰 코드를 입력하시면 됩니다. 쿠폰마다 사용 조건이 다르니 확인해 주세요.'},
  ];
