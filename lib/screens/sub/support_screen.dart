      ...
      appBar: AppBar(
        title: Column(
          ...
          children: const [
            ...
            Text('도움이 필요하신가요?', style: TextStyle(fontSize: 14, color: AppColors.gray500)),
          ],
        ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const Text('평일 9:00 - 18:00', style: TextStyle(fontSize: 14, color: Colors.white70)),
                  ...
                  if (expanded)
                    Container(
                      ...
                      child: Container(
                        ...
                        child: Text(faq['answer']!, style: const TextStyle(fontSize: 14, color: AppColors.gray700, height: 1.5)),
                      ),
                    ),
                ],
              ),
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('kimsungil322@gmail.com', style: TextStyle(fontSize: 14, color: AppColors.blue600)),
                    ],
                  ),
                ),
