          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                SizedBox(width: 8),
                Expanded(child: Text('알림을 받으려면 기기의 알림 설정도 활성화되어 있어야 합니다.', style: TextStyle(fontSize: 14, color: AppColors.blue700, height: 1.4))),
              ],
            ),
          ),
        ],
...
class _NotifItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SwitchListTile(
      ...
      subtitle: Text(subtitle, style: const TextStyle(fontSize: 14, color: AppColors.gray500)),
      value: value,
      onChanged: onChanged,
